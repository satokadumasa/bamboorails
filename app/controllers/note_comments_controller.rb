class NoteCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note_comment.save
        format.html { redirect_to @note_comment, notice: 'Note comment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @note_comment.update(note_comment_params)
        format.html { redirect_to @note_comment, notice: 'Note comment was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to note_comments_url, notice: 'Note comment was successfully destroyed.' }
  ...
  private
    ...
    def note_comment_params
      params.require(:note_comment).permit(:user_id, :bbs_id, :title, :body)
    end
